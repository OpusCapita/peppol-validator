...
<xsl:stylesheet xmlns:xhtml="http://www.w3.org/1999/xhtml"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cbc:CustomizationID" priority="1058" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cbc:CustomizationID"/>
        <xsl:apply-templates select="*" mode="M10"/>
    </xsl:template>
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cbc:ProfileID" priority="1057" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cbc:IssueDate" priority="1055" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cbc:IssueDate"/>
        <xsl:apply-templates select="*" mode="M10"/>
    </xsl:template>
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cbc:IssueTime" priority="1054" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cbc:IssueTime"/>
        <xsl:apply-templates select="*" mode="M10"/>
    </xsl:template>
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cbc:Note" priority="1053" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cbc:Note"/>
        <xsl:apply-templates select="*" mode="M10"/>
    </xsl:template>
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:SenderParty" priority="1052" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cbc:EndpointID" priority="1051"
                 mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact" priority="1045"
                 mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/*" priority="1041"
                 mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cac:SenderParty/cac:Contact/*"/>
        <!--ASSERT -->
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:SenderParty/*" priority="1040" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cac:SenderParty/*"/>
        <!--ASSERT -->
        <xsl:choose>
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty" priority="1039" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:ReceiverParty/*" priority="1032" mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cac:ReceiverParty/*"/>
        <!--ASSERT -->
        <xsl:choose>
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse" priority="1031"
                 mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="/ubl:ApplicationResponse/cac:DocumentResponse/*" priority="1001"
                 mode="M10">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/ubl:ApplicationResponse/cac:DocumentResponse/*"/>
        <!--ASSERT -->
    ...
    <!--RULE -->
    <xsl:template match="cac:Status[cbc:StatusReasonCode='OTH']" priority="1002" mode="M11">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--RULE -->
    <xsl:template match="cac:Status[cbc:StatusReasonCode='PPD']" priority="1000" mode="M11">
        <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(/cbc:ResponseCode='PD')">
